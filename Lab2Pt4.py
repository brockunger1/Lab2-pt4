...
print("Days :", Days, "Hours: ", "Minutes: ", Minutes, "Seconds: ", Seconds, "After the start of 2022, total population was: ", b, "The average amount of flapjacks eaten is: ", flapjack)
